/**
 * Upsert Study.com College Algebra (matches supabase migration).
 * Run: SUPABASE_SERVICE_KEY=... node scripts/add-study-com-algebra.mjs
 */
	...
	.upsert(
		{
			...
			slug,
			description:
				'Study.com College Algebra covers equations, inequalities, functions, polynomials, exponentials, logarithms, and graphing — typical first-college algebra topics delivered through video lessons, practice, and assessments. Earn credit through the College Accelerator plan; courses carry ACE and NCCRS recommendations. Always confirm transfer with your receiving institution.',
			short_description:
			...
			course_url: 'https://study.com/academy/course/algebra.html',
			image_url: '/images/courses/study-com-algebra.png',
			duration: 'Self-paced',
			level: 'Introductory',
			price: '$95/mo',
			price_numeric: 95,
